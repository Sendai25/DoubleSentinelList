...
int main2() {
	...
	std::cout << "The value of the node returned by rbegin should be 5: " << list2.rbegin()->value() << std::endl;
	std::cout << "The value of the back should be 5: " << list2.back() << "\n" << std::endl;


	std::cout << "After move constructor the original list should be empty (1): " << list.empty() << std::endl;
	std::cout << "The size should be 0: " << list.size() << std::endl;
	std::cout << "The next pointer of begin should be the null pointer: " << list.begin()->next() << std::endl;
	std::cout << "The begin should equal end: " << (list.begin() == list.end()) << std::endl;
